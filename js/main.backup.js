...
setTimeout(() => {
  ...
  setTimeout(() => {
    ...
    initDoorSystem();
    // Hero background video — start after intro, play once, freeze on last frame
    ...
    if (heroBgVideo) {
      ...
      heroBgVideo.addEventListener('ended', () => {
        ...
        // Show portal canvas immediately with frame 0
...
document.querySelectorAll('#open-contact-hero, #open-contact-footer').forEach(btn => {
  if (btn && overlay) {
